...
import { loginGoogle, loginUsuario, registroUsuario } from '../Firebase/client.js';
...
const Login = () => {
    ...
    return (
            <main>
                  <section>
                    <h1>Firebase Auth</h1>
                    <input type="email" placeholder='Correo electrónico' value={formData.email} onChange={(e) => 
                      setFormData({...formData, email: e.target.value})}/>
        
                    <input type="password" placeholder='Contraseña' value={formData.password} onChange={(e) => 
                    ...
                    <h3>ó</h3>
                    <button onClick={loginGoogle}>{ isLogin ? 'Iniciar sesión con Google' : 'Registrate con Google' }</button>
                    {
                      isLogin
